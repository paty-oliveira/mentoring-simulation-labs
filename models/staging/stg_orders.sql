...
renamed as (
    ...
    select
        ...
        -- NOTE: this same CASE WHEN block is repeated in fct_orders.sql — a great macro candidate!
        case order_status
        ...
        case
            when order_status in ('placed', 'processing', 'shipped') then true
            else false
        ...
        case
            when discount_code is not null and discount_code != '' then true
            else false
        end                             as has_discount,
        ...
        -- Date truncations — repeated across models (Jinja variable/loop opportunity!)
